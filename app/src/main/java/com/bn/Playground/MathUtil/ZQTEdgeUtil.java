...
public class ZQTEdgeUtil 
{
	...
	{		
		...
		//规格化AB向量
		float[] normalAB=VectorUtil.normalizeVector(abVector);
		//AB向量叉乘原始圆柱向量
		float[] a = {normalAB[0],normalAB[1],normalAB[2]};
		float[]	b = {ZHU_VECTOR_NORMAL[0], ZHU_VECTOR_NORMAL[1], ZHU_VECTOR_NORMAL[2]};
		float[] normalABCrossZhu= VectorUtil.normalizeVector(VectorUtil.crossTwoVectors(a, b));
		//求AB向量与原始圆柱向量的夹角
		...
		//求长度缩放值
		float scale=VectorUtil.module(abVector)/STANDARD_EDGE_LENGTH;//求长度缩放值
