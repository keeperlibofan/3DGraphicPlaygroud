...
/**四个顶部的Factory类*/
public class TopPart implements Graph {
    ...
    private float scale;
    private float vCount;
    private int texId;

    private FloatBuffer mVertexBuffer;//顶点坐标数据缓冲
    private FloatBuffer   mTexCoorBuffer;//顶点纹理坐标数据缓冲

    public TopPart(MySurfaceView mv, float scale, int nCol ,int nRow, int texId, ArrayList<BNPosition> positions) {
        this.texId = texId;
        this.scale = scale;
