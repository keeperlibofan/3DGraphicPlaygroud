...
import static com.bn.Playground.ShaderUtil.createProgram; // 引入静态方法
...
{	
    ...
    public Regular20(MySurfaceView mv, float scale, float aHalf, int n, int texId)
    {
    	this.texId = texId;
	...
	{//自定义的初始化顶点数据的方法
		...
		float sSpan=1/5.5f;//每个纹理三角形的边长 这个计算和排布有关
